...
- [x] Evidence level recorded per field; `targets/evidence/` populated — ATF22V10 fuse map measured and recorded in [#30](https://github.com/enthal/decpld/pull/30), with the complete fuse-address map added in [#35](https://github.com/enthal/decpld/pull/35); per-field levels in [#44](https://github.com/enthal/decpld/pull/44), as a `Mapping` table whose citations are checked against the experiment suite on disk rather than only written in comments
