...
- [ ] Decode: fuse vector → `PhysicalDesign` — `decode_row` recovers a product term and `ConfigField::decode` a macrocell's mode and polarity ([#37](https://github.com/enthal/decpld/pull/37), [#38](https://github.com/enthal/decpld/pull/38)); assembling them into a whole design is what remains
- [ ] Invariants: matrix cells map 1:1 to fuses, no undocumented field overlap, every fuse classified, every legal configuration round-trips — cells-to-fuses and fuse classification are construction-time in [#28](https://github.com/enthal/decpld/pull/28) and [#37](https://github.com/enthal/decpld/pull/37); every legal macrocell configuration round-trips in [#38](https://github.com/enthal/decpld/pull/38)
